...
class RandomSequenceWithDistractors(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        seq_train_frames, seq_train_anno = dataset.get_frames(seq_id, train_frame_ids, seq_info_dict)

        seq_test_frames, seq_test_anno = dataset.get_frames(seq_id, test_frame_ids, seq_info_dict)
