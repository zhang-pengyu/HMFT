...
if __name__ == "__main__":
    ...
    tracker.parameters.train_skipping = 20
    tracker.parameters.net_opt_update_iter = 2
    tracker.parameters.target_not_found_threshold = 0.08
    
    for name in seq_list:

        save_path = './results_RGBT210/'  + name + '.txt'
        save_folder = './results_RGBT210/'
        ...
        rgb_gt = np.loadtxt(seq_home + '/' + name + '/init.txt',delimiter=',')
