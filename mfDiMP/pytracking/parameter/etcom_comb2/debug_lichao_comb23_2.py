...
def parameters():
    ...
    # deep_feat = trackernet.SimpleTrackerResNet18(dis_net_path='dis_tracker.pth.tar',comp_net_path='comp_tracker.pth.tar',
                                                #  fparams=deep_fparams)

    deep_feat = trackernet.SimpleTrackerResNet18(dis_net_path='OptimTracker_ep0025.pth.tar',
                                                 fparams=deep_fparams)
